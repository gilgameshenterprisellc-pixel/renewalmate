...
const VS_DATA: Record<string, {
  ...
  'rocket-money': {
    ...
    rows: [
      ...
      { feature: 'Free tier', them: 'Limited — tracking only', us: 'Full manual tracking, always free' },
      { feature: 'Bank account sync', them: 'Required', us: 'Optional (Plus) — never required, your data stays yours' },
  ...
  'monarch-money': {
    ...
    rows: [
      ...
      { feature: 'Bank sync required', them: 'Yes', us: 'No — manual by default, optional on Plus' },
  ...
  'ynab': {
    ...
    rows: [
      ...
      { feature: 'Bank sync', them: 'Required', us: 'Never required (optional on Plus)' },
  ...
  'copilot': {
    ...
    rows: [
      ...
      { feature: 'Free tier', them: 'None after trial', us: 'Full manual tracking, always free' },
      { feature: 'Bank sync', them: 'Required', us: 'Never required (optional on Plus)' },
  ...
  'pocketguard': {
    ...
    rows: [
      ...
      { feature: 'Free tier', them: 'Very limited', us: 'Full manual tracking, always free' },
      { feature: 'Bank sync', them: 'Required', us: 'Never required (optional on Plus)' },
  ...
  'simplifi': {
    ...
    rows: [
      ...
      { feature: 'Free tier', them: 'None', us: 'Yes — manual tracking is free' },
      { feature: 'Bank sync', them: 'Required', us: 'Never required (optional on Plus)' },
  ...
  'mint': {
    ...
    rows: [
      ...
      { feature: 'Bank sync', them: 'Required (was)', us: 'Never required (optional on Plus)' },
